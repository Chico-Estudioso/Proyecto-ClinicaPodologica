    ...
    <div className="container mx-auto px-4 md:px-6 py-12">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-gray-700 max-w-2xl mx-auto">
          ...
          cualquier consulta o para pedir cita.
        </p>
      </div>
        ...
        <div className="space-y-8">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Calle Agustín Carreño 2 Bajo 2 Clínica del pie
                  </p>
          ...
          <div>
            ...
            <p className="mt-4 text-gray-700">
              Estamos ubicados en una zona céntrica de fácil acceso, con paradas
              de transporte público cercanas y aparcamiento disponible.
            </p>
          </div>
        </div>
      </div>
